    ...
    <main className="">
      ...
      <div className={`${urbanist.variable} ${nunitoSans.variable}`}>
            ...
            <div className="pt-18 lg:hidden block">
              <div className="font-urbanist text-white text-3xl absolute pl-5 top-27 sm:top-42 sm:text-4xl sm:pl-14 md:top-45 [@media(min-width:900px)]:top-53 md:text-5xl  md:pl-13 [@media(min-width:900px)]:pl-15 lg:top-43 lg:pl-14">
                <p className="">Journey with Ease</p>
                <p className="">Across Japan</p>
              </div>
              <div className="font-urbanist text-white text-[10px] absolute top-65 pl-5 sm:pl-14 sm:top-95 sm:text-[14px] md:pl-13 md:top-109 md:text-[18px] lg:top-110 lg:pl-14 ">
            ...
            <div className="lg:hidden block">
              <div className="bg-[rgb(255,195,206)] text-white  h-auto rounded-2xl absolute top-138 left-10 w-auto">
                  <button className="px-3 font-nunito-sans"><Link href="">Explore</Link></button></div>
              <h1 className="text-3xl absolute top-107 left-81 text-white font-urbanist sm:top-148 sm:left-115 sm:text-5xl md:top-172">Chubu</h1>
              <p className="font-urbanist text-white text-[10px] absolute top-133 left-53 sm:top-189 sm:left-80 sm:text-[14px]">Explore the Castles and Shrines of Aichi to the</p>
              <p className="font-urbanist text-white text-[10px] absolute top-136 left-65 sm:top-193 sm:left-98 sm:text-[14px]">Five Lakes of Mt. Fuji in Yamanashi,</p>
              <p className="font-urbanist text-white text-[10px] absolute top-139 left-70 sm:top-197 sm:left-104 sm:text-[14px]">or Explore the Shrines of Fukui</p>
      ...
      <div className="[@media(min-width:625px)]:text-white">awhduaihdiawhdiawda</div>
